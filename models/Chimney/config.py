...
train_dataset_path = 'config/train_all.txt'
test_dataset_path = 'config/test_all.txt'

# The folder to save log and model
log_base_dir = '/media/debayan/ssd2/Universal/log/chimney/'
name = 'pre_{}'.format(pre)
